...
import com.unico.camerasurface.camera.utils.camera.AutoFitTextureView;
...
import com.unico.camerasurface.camera.utils.camera.ImageSize;
import com.unico.camerasurface.camera.utils.bitmap.ImageUtils;
import com.unico.camerasurface.camera.utils.exif.Exif;
...
public class Camera2BaseActivity extends BaseCameraActivity implements View.OnClickListener {
    ...
    protected static iCamera icamera;
    ...
    // This variable discriminate if the camera is running in background or not.
    protected boolean isStopCamera = false;
    ...
    protected final CameraDevice.StateCallback stateCallback = new CameraDevice.StateCallback() {
        ...
        public void onOpened(@NonNull CameraDevice cameraDevice) {
            ...
            Camera2BaseActivity.this.cameraDevice = cameraDevice;
        ...
        public void onDisconnected(@NonNull CameraDevice cameraDevice) {
            ...
            cameraOpenCloseLock.release();
            cameraDevice.close();
            Camera2BaseActivity.this.cameraDevice = null;
        }
        ...
        public void onError(@NonNull CameraDevice cameraDevice, int error) {
            ...
            // createCameraPreviewSession();
            //returnToPreviousActivityError("ERRO DESCONHECIDO NA CÂMERA");
        }
        ...
        AsyncTask.THREAD_POOL_EXECUTOR.execute(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.d(TAG,"Erro de acesso a camera: " +  e.toString());
                }
            }
        });
    }
